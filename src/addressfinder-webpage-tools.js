...
function () {
  ...
  _createClass(FormManager, [{
    ...
    } // Sets the value of each of the elements to an empty string
...
function () {
  function PageManager(_ref) {
    ...
    this.version = "1.5.0"; // Each formHelper is an instance of the FormManager class
  ...
  _createClass(PageManager, [{
    ...
    value: function _initialiseFormHelper(addressFormConfig) {
      ...
      if (searchElement) {
        ...
        var helper = new __WEBPACK_IMPORTED_MODULE_0__form_manager__["a" /* default */](this.widgetConfig, formHelperConfig, this.formFieldChangeEventToDispatch, this.countryChangeEventToListenFor);
